...
export default function LoginPage() {
  ...
  return (
    ...
    >
      <div className="grid w-full max-w-5xl overflow-hidden rounded-3xl border border-[#B2D959]/30 bg-white shadow-[0_25px_70px_rgba(126,193,81,0.18)] lg:grid-cols-2">
        ...
        >
          {/* Decorative circles */}
          <div className="absolute -right-24 -top-24 h-64 w-64 rounded-full bg-white/20" />
          ...
          <div className="relative z-10 max-w-md">
            ...
            <p className="mt-5 text-base leading-7 text-white/90">
              Manage your links, track clicks, and build a
              cleaner link-sharing experience with LinkSnap.
            </p>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm leading-6 text-[#8FA28A]">
                Log in to continue managing your short links.
              </p>
            </div>
